...
let serial = ['first','second','third','four','five','six']; //id названий команд
let serial_point = ['first_point','second_point','third_point','four_point','five_point','six_point']; //id очков команд
